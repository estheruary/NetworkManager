...
nm_setting_bridge_class_init (NMSettingBridgeClass *klass)
{
	 ...
	 * variable: BRIDGING_OPTS: group-address=
	 * description: STP group address.
	 * example: BRIDGING_OPTS="group-address=01:80:C2:00:00:0A"
	 * ---end---
	 */
	 ...
	 * variable: BRIDGING_OPTS: vlan-protocol=
	 * description: VLAN filtering protocol.
	 * example: BRIDGING_OPTS="vlan-protocol=802.1Q"
	 * ---end---
	 */
	 ...
	 * variable: BRIDGING_OPTS: vlan-stats-enabled=
	 * default: 0
	 * example: BRIDGING_OPTS="vlan-stats-enabled=1"
	 * ---end---
	 */
	 ...
	 * variable: BRIDGING_OPTS: multicast-router=
	 * values: auto, enabled, disabled
	 * default: auto
	 * example: BRIDGING_OPTS="multicast-router=enabled"
	 * ---end---
	 */
	 ...
	 * variable: BRIDGING_OPTS: multicast-query-use-ifaddr=
	 * default: 0
	 * example: BRIDGING_OPTS="multicast-query-use-ifaddr=1"
	 * ---end---
	 */
